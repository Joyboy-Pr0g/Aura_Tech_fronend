...
export function slideInVariants(fromStart: boolean): Variants {
  const x = fromStart ? -36 : 36;
  return {
...
/** Self-contained scroll reveal — works for infinite lists too */
...
export function SlideIn({
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate={active ? 'visible' : 'hidden'}
      variants={slideInVariants(fromStart)}
      transition={{ delay }}
      className={className}
    >
      {children}
